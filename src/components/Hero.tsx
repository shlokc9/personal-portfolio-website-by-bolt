      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-8xl py-8 sm:py-6">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              I'm a backend & full-stack engineer with a deep appreciation for the CNCF ecosystem. I love building scalable microservices & designing robust MLOps, LLMOps, & DevOps strategies for cloud-native systems. Committed to open-source, I deliver resilient, observable distributed architectures.
            </motion.p>
            ...
            >
              ...
              <motion.a
                href="https://drive.google.com/file/d/1MPtNh6noV6DXqBDZsXFsZBf2wcvRkoJS/view?usp=sharing"
                target="_blank"
